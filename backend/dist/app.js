...
export function createApp(options) {
    ...
    const productController = new ProductController(createProductUseCase, listProductsUseCase, getProductUseCase, updateProductUseCase, consumeStockUseCase, restockProductUseCase, deleteProductUseCase, getStockHistoryUseCase);
    const newsController = new NewsController(createNewsUseCase, listNewsUseCase, getNewsUseCase, updateNewsUseCase, deleteNewsUseCase);
    // Register Routers
